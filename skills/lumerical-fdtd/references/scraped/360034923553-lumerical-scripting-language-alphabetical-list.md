...
Source URL: https://optics.ansys.com/hc/en-us/articles/360034923553-Lumerical-scripting-language-Alphabetical-list  
Area: Scripting  
...
This local capture indexes the official page `Lumerical scripting language - Alphabetical list` for the topic `Command lookup and deprecation notes`. It captured 28 heading(s), 841 link(s), 0 code block(s), 0 inline code term(s), and 0 table(s). Main headings: Lumerical scripting language - Alphabetical list, A, B, C, D, E, F, G. Key detected terms: analysis, bloch, boundary, command, dataset, dipole, far, fdtd, gaussian, geometry, grating, group, import, material, mesh, mode.
