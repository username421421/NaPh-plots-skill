...
Source URL: https://optics.ansys.com/hc/en-us/articles/360034902393  
...
This local capture indexes the official page `Frequency-domain monitor - Simulation object` for the topic `Discovered from Ports (FDTD) - Simulation Object`. It captured 7 heading(s), 6 link(s), 0 code block(s), 0 inline code term(s), and 4 table(s). Main headings: Frequency-domain monitor - Simulation object, General tab, Geometry tab, Data to record, Spectral averaging and apodization tab, Advanced tab, Results returned. Key detected terms: analysis, boundary, far, far-field, fdtd, geometry, import, material, mesh, mode, monitor, normalization, plane, pml, port, script.
