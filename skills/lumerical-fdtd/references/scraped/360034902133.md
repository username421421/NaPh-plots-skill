...
Source URL: https://optics.ansys.com/hc/en-us/articles/360034902133  
...
This local capture indexes the official page `Understanding source normalization in the TFSF source` for the topic `Discovered from Tips and best practices when using the FDTD TFSF source`. It captured 5 heading(s), 6 link(s), 2 code block(s), 0 inline code term(s), and 2 table(s). Main headings: Understanding source normalization in the TFSF source, Source power vs source intensity, Angles of incidence, Periodic structures, Structures on multi-layer stacks or substrates. Key detected terms: analysis, bfast, bloch, boundary, command, fdtd, grating, import, mesh, mode, monitor, normalization, periodic, plane, port, reflection.
