...
Source URL: https://optics.ansys.com/hc/en-us/articles/360034901473-Structures-Rectangle  
...
This local capture indexes the official page `Rectangle - Simulation Object` for the topic `Discovered from FDTD`. It captured 6 heading(s), 12 link(s), 0 code block(s), 0 inline code term(s), and 0 table(s). Main headings: Rectangle - Simulation Object, Geometry tab, Material tab, Rotation tab, Graphical Rendering tab, See also. Key detected terms: fdtd, geometry, material, mesh, mode, structure.
