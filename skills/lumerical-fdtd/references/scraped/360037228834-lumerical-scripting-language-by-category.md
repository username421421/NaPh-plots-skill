...
Source URL: https://optics.ansys.com/hc/en-us/articles/360037228834-Lumerical-scripting-language-By-category  
...
This local capture indexes the official page `Lumerical scripting language - By category` for the topic `Discovered from Lumerical Python API Reference`. It captured 100 heading(s), 821 link(s), 0 code block(s), 0 inline code term(s), and 0 table(s). Main headings: Lumerical scripting language - By category, Adding objects, Simulation environment, Structures, Simulation region, Sources, Monitors, Create objects in Deck. Key detected terms: analysis, bloch, boundary, command, dataset, dipole, far, far-field, fdtd, gaussian, geometry, grating, group, import, lumapi, material.
