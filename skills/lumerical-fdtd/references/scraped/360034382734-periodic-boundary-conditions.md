...
Source URL: https://optics.ansys.com/hc/en-us/articles/360034382734-Periodic-boundary-conditions  
...
This local capture indexes the official page `Periodic boundary conditions in FDTD and MODE` for the topic `Discovered from FDTD product reference manual`. It captured 3 heading(s), 9 link(s), 0 code block(s), 0 inline code term(s), and 0 table(s). Main headings: Periodic boundary conditions in FDTD and MODE, Additional Tips, See also. Key detected terms: bfast, bloch, boundary, dipole, fdtd, import, material, mesh, mode, periodic, plane, pml, port, source, structure, symmetry.
