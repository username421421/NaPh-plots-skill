...
Source URL: https://optics.ansys.com/hc/en-us/articles/360034395194  
...
This local capture indexes the official page `Changing the far field refractive index analysis object` for the topic `Discovered from Far field projections in FDTD overview`. It captured 5 heading(s), 4 link(s), 2 code block(s), 0 inline code term(s), and 1 table(s). Main headings: Changing the far field refractive index analysis object, Setting the far field refractive index in the far field projection functions, Example, Fresnel correction, See also. Key detected terms: analysis, command, far, fdtd, gaussian, group, import, material, mode, monitor, plane, port, reflection, script.
