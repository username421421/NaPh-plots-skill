...
Source URL: https://optics.ansys.com/hc/en-us/articles/360034924573-addmodeexpansion  
...
This local capture indexes the official page `addmodeexpansion - Script command` for the topic `Discovered from Lumerical scripting language alphabetical list`. It captured 1 heading(s), 11 link(s), 1 code block(s), 0 inline code term(s), and 1 table(s). Main headings: addmodeexpansion - Script command. Key detected terms: command, fdtd, mode, monitor, script, solver.
