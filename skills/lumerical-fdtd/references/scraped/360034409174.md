...
Source URL: https://optics.ansys.com/hc/en-us/articles/360034409174  
...
This local capture indexes the official page `updateportmodes - Script command` for the topic `Discovered from Ports (FDTD) - Simulation Object`. It captured 1 heading(s), 8 link(s), 2 code block(s), 0 inline code term(s), and 1 table(s). Main headings: updateportmodes - Script command. Key detected terms: command, fdtd, mode, port, script, solver, source.
